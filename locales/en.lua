Locales['en'] = {
  ...
  ['vehicleshop_bought'] = '<center>คุณได้ซื้อรถ <strong class="yellow-text">%s</strong> ราคา <strong class="green-text">$%s</strong><center>',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~gouvernment~s~',
  -- Vehicle interaction
  ...
  ['have_withdrawn'] = '<center>You have withdrawn <strong class="yellow-text">%sx</strong> <strong class="blue-text">%s</strong><center>',
  ['have_deposited'] = '<center>You have deposited <strong class="yellow-text">%sx</strong> <strong class="blue-text">%s</strong><center>',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['gouvernment_stock'] = 'gouvernment Stock',
  -- Misc
  ['remove_prop'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = '<font face="font4thai">สถานีตํารวจ</font>',
  ['unrestrained_timer'] = 'you feel your handcuffs slowly losing grip and fading away.',
  -- Notifications
  ['alert_gouvernment'] = 'gouvernment alert',
  ['phone_gouvernment'] = 'gouvernment',
}
